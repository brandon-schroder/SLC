...
| **AGARD745** | Çetin, Üçer, Hirsch & Serovy, *Application of Modified Loss and Deviation Correlations to Transonic Axial Compressors*, AGARD-R-745 (1987) | loss-models notebook (paywalled report) | The MCA/transonic deviation correction (`lieblein.cetin_deviation_correction`; Rotor 37 gap). | **Eq. 3.5 ADOPTED 2026-07-16** (verbatim, opt-in, C¹-saturated): Rotor 37 per-span deviation RMS 3.8°→1.2° with no local constant; Tier-2 PR lands on measured (2.051 vs 2.056). Swan Eq. 70 off-design + Crouse m-factor recorded, deferred. [`AGARD745.md`](AGARD745.md), `tests/test_cetin_correction.py`. |
