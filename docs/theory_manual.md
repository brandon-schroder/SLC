...
|---|---|---|---|---|
| PR (total-to-total) | 2.026 | 1.969 | — (wedge) | $(1.5, 4.0)$, $>1$ (compression) |
| efficiency | 0.799 | 0.803 | — (wedge) | $(0.6, 0.999)$ |
...
Tier 1 and Tier 2 agree on PR to $<3\%$. **Efficiency reads a realistic ~0.80** now that the dominant blade-loading loss is modelled (it was ~0.98 when only incidence + skin-friction were); tip-clearance/disk-friction stay deferred. Point-by-point Eckardt reproduction and stage-map traversal are **[VERIFY]**, blocked on the reference library and the deferred loss components.
